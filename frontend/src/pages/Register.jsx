...
import { registerUser, googleLoginUser, getGoogleConfig } from "../services/authService";
import { useNavigate } from "react-router-dom";
import { useAuth } from "../context/AuthContext";
import { User, Mail, Lock, ArrowLeft, Code2, Sparkles, Sun, Moon } from "lucide-react";
import "./Register.css";
...
function Register() {
  ...
  return (
    <div className={`register-page ${theme === "light" ? "light-theme" : ""}`}>
      ...
      <div className="register-card-container">
        <div className="register-header">
          ...
          <p className="register-subtitle">
            Join the Code Expo developer community and collaborate in real-time.
          </p>
        </div>
        ...
        <div className="register-card-footer">
          ...
          <button onClick={nav_to_login} className="btn-link-login">
            Log in
          </button>
        </div>
      </div>
