    ...
    <aside className="rebuilt-right-column">
      ...
      <div className="feed-premium-card">
        <div className="right-card-title" style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "14px" }}>
          ...
          <span style={{ fontSize: "0.88rem", fontWeight: "700", color: "#ffffff" }}>Online Developers ({onlineUsers.length})</span>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          {onlineUsers.length === 0 && (
            <div style={{ fontSize: "0.82rem", color: "rgba(255,255,255,0.45)" }}>No developers online right now</div>
          )}
        </div>
      </div>
      ...
      <div className="feed-premium-card">
        <div className="right-card-title" style={{ fontSize: "0.88rem", fontWeight: "700", color: "#ffffff", marginBottom: "14px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "6px", flexShrink: 0, marginLeft: "auto" }}>
                  ...
                  <button
                    ...
                    style={{
                      background: isFollowing ? "rgba(255, 255, 255, 0.06)" : "linear-gradient(135deg, #6366f1 0%, #4f46e5 100%)",
                      border: isFollowing ? "1px solid rgba(255, 255, 255, 0.12)" : "none",
                      borderRadius: "8px",
                      color: isFollowing ? "rgba(255, 255, 255, 0.75)" : "#ffffff",
                      padding: "6px 12px",
                      fontSize: "0.76rem",
                      fontWeight: "600",
                      cursor: "pointer",
          ...
          {suggestedUsers.length === 0 && (
            <div style={{ fontSize: "0.82rem", color: "rgba(255,255,255,0.45)" }}>No suggested developers right now</div>
          )}
        </div>
      </div>
      ...
      <div className="feed-premium-card">
        <div className="right-card-title" style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "14px" }}>
          ...
          <span style={{ fontSize: "0.88rem", fontWeight: "700", color: "#ffffff" }}>Trending Tags</span>
        </div>
